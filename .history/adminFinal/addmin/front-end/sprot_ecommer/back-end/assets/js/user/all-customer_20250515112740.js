    ...
    currentPageData.forEach(user => {
        ...
        $('#user-table-body').append(`
            <tr>
                ...
                <td>${user.phone}</td>
                <td>${user.email}</td>
                <td class="td-check" style="text-align: center;" >${statusIcon}</td>
<td class="td-check" style="text-align: center;">${user.totalOrders}</td>
<td class="td-check" style="text-align: center;">${totalSpentFormatted}</td>
                <td>
                    <ul>
