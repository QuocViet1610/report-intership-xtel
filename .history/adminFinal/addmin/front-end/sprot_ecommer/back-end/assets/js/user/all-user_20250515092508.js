...
function setupActionEvents() {
    // Toggle lock/unlock user - using class instead of ID
...
// Also update your renderUserTable function to use the correct classes
function renderUserTable(page, size) {
    // Clear current table
    $('#user-table-body').empty();
    ...
    currentPageData.forEach(user => {
        ...
        $('#user-table-body').append(`
            <tr>
                ...
                <td>
                    <ul>
                        <li class="toggle-lock" data-id="${user.id}">
                            <a href="javascript:void(0)">
                                <i class="ri-lock-line"></i>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                data-bs-target="#exampleModalToggle" class="delete-user-btn" data-id="${user.id}">
                                <i class="ri-delete-bin-line"></i>
                            </a>
                        </li>
                    </ul>
