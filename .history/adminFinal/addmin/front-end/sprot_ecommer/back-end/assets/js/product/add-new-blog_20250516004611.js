$(document).ready(function () {
    ...
    $('#btn-create').on('click', function (e) {
        ...
        // $('.dropdown-item-object').on('click', function(e) {
        //     e.preventDefault();

        //     // Lấy data-id của item được chọn
        //     selectedCategoryId = $(this).data('id');

        //     // Lấy tên hiển thị của item
        //     const selectedText = $(this).text();

        //     // Cập nhật text lên nút dropdown
        //     $('#dropdownButtonObject').text(selectedText);

        //     console.log('Đã chọn thể loại ID:', selectedCategoryId);
        // });
