...
$(document).on('click', '.custom-btn', function(e) {
...
// update brand
    ...
    var brandName = $('#brandNameInputUpdate').val().trim();
    ...
    $.ajax({
        url: `http://localhost:8080/brand/${brandIdUpdate}`, 
        type: 'PUT',
        data: formData,
        headers: {
          "Authorization": "Bearer " + token,
