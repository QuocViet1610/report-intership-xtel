$(document).ready(function () {
 ...
 const items = document.querySelectorAll('.dropdown-item-object');
  ...
  items.forEach(item => {
    item.addEventListener('click', function(e) {
      ...
      // Làm gì đó với id, ví dụ:
      console.log('Bạn đã chọn id =', id);

      // Nếu bạn muốn hiển thị tên item lên nút dropdown:
      const dropdownBtn = document.getElementById('dropdownButtonObject');
