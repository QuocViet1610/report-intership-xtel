            ...
            reviews.forEach(review => {
                ...
                tableRows += `
                    <tr class="review-row">
                        ...
                        <td>
                            <ul class="rating">
                                ${review.ratingValue} <i class="fa-solid fa-star" style="color: yellow;"></i>Sao <!-- Render sao dựa trên rating -->
                            </ul>
                        </td>
...
$('#updateStatusBtn').on('click', function() {
    ...
    // $.ajax({
    //     url: `http://localhost:8080/product-rating/${reviewId}/update-status`,  // Đường dẫn API để cập nhật trạng thái
    //     type: 'POST',
    //     contentType: 'application/json',
    //     data: JSON.stringify({ isActive: newStatus }),  // Gửi trạng thái mới
    //     success: function(response) {
