...
$(document).ready(function() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function () {
        ...
        // Uncomment this AJAX call when you're ready to implement deletion
        /*
        $.ajax({
            url: `/blog/${blogIdToDelete}`,
            type: 'DELETE',
            headers: {
            ...
            success: function(response) {
                ...
                // Reload the page or remove the element from the DOM
                location.reload();
            },
        ...
        */
        ...
        alert('Xoá thành công! (AJAX call is currently commented out)');
        const deleteModal = bootstrap.Modal.getInstance(document.getElementById('deleteConfirmModal'));
        deleteModal.hide();
        blogIdToDelete = null;
    });
...
function showError(message) {
    // Hiển thị thông báo lỗi (có thể thay bằng toast hoặc modal)
