    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.code === "200") {
                ...
                allUserData = allUserData.filter(user => user.id !== 23);
            ...
            <tr>
                ...
                <td>
                    <ul>
                        ...
                        <li id="toggle-permission" data-id="${user.id}">
                            <a href="update-staff.html?id=${user.id}">
                               <i class="ri-pencil-line" data-id="${user.id}" class="edit-btn"></i></a></li>
                            </a>
                        </li>
                    </ul>
                </td>
