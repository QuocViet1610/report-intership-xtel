            ...
            <div class="product-footer">
                <div class="product-detail">
                    ...
                    <div class="product-rating mt-2">
                        <ul class="rating">
                            ${getRatingStars(product.productTotalRating || 0)}
                        </ul>
...
var productAverageRating = (reviews && reviews.length > 0 && reviews[0].productAverageRating !== undefined) 
    ? reviews[0].productAverageRating 
    : 0;
...
function updateProductInfo() {
    ...
    if (selectedVariant.length > 0) {
        ...
        $('#stock').text(typeof variant.quantity !== 'undefined' ? variant.quantity : 'Không có thông tin');
