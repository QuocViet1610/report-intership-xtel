...
$(document).on('click', '.notifi-wishlist', function(e) {
    ...
    const productId = $this.data('data-product-id');
    ...
    if (!name || !image) {
        ...
        const  productId = productBox.find('.buy-button').data('product-id');
        const article = 'product-left-thumbnail.html?id=' + productId;
