...
$.ajax({
    ...
    success: function(response) {
        if (response.data && response.data.content) {
                        ...
                        <div class="product-box-3 wow fadeInUp">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-2.html">
                                        <img src="${product.imageUrl}" class="img-fluid blur-up lazyload" alt="${product.name}">
                                    </a>
                            ...
                            <div class="product-footer">
                                <div class="product-detail">
                                    ...
                                    <h5 class="price"><span class="theme-color">${product.price}đ</span></h5>
            ...
            // Insert the dynamically created products into the page
            $('.slider-6_1.product-wrapper').html(productListHTML);
        }
    },
    error: function(xhr, status, error) {
        let errorMessage = "Lịch sử giao hàng đang trống";
