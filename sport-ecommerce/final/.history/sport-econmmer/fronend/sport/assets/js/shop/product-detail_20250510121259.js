            ...
            <div class="product-header">
                <div class="product-image">
                    <a href="/product/detail?id=${product.id}">
                        <img src="${product.productImageUrl || 'https://via.placeholder.com/300'}"
...
function loadRelatedProducts(categoryId) {
    ...
    const requestData = {
        ...
        // Có thể thêm các tham số khác nếu cần thiết
    };
    
    $.ajax({
        url: "http://localhost:8080/product/search?page=0&size=6&sort=productTotalSold.desc",
        type: "POST", 
        contentType: "application/json",  
        data: JSON.stringify(requestData),  
        success: function(response) {
