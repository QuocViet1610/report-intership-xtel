        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.code === '200') {
                    ...
                    // Định dạng lại thành ngày tháng năm theo kiểu dễ đọc
                    const options = { year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit' };

                    const formattedCreatedAt = createdAtDate.toLocaleString('vi-VN', options);
                    const formattedUpdatedAt = updatedAtDate.toLocaleString('vi-VN', options);

                    console.log("Created At: ", formattedCreatedAt);  // "Ngày 5 tháng 5, 2025 20:15:57"
                    console.log("Updated At: ", formattedUpdatedAt);
                    document.getElementById('timePlaced').textContent = response.data.createdAt;
