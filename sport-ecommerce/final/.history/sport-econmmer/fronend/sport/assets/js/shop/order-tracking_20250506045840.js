        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                orderDetail.forEach(item => {
                    ...
                    let totalPrice = parseFloat(productPrice) * parseInt(quantity);// Tính tổng giá của sản phẩm
                    ...
                    if (item.productVariants && item.productVariants.length > 0) {
                        ...
                        totalPrice = parseFloat(productPrice) * parseInt(quantity) // Cập nhật tổng giá khi có variant
                    }
                
                    // Hiển thị thông tin sản phẩm trong console
                    console.log(`Sản phẩm: ${productName}`);
                    console.log(`Giá: ${productPrice}đ`);
                    console.log(`Số lượng: ${quantityProduct}`);
                    console.log(`Tổng giá: ${totalPrice}đ`);
