...
$(document).ready(function() {
 ...
 $.ajax({
  ...
  const reviews = response.data; // Giả sử response.data là một mảng các đánh giá
   const productAverageRating = response.data.productAverageRating; 

        // Gắn giá trị vào trong HTML
   const productAverageRating = response.data.productAverageRating; // Giá trị productAverageRating từ response
