        ...
        if (response.data && response.data.content) {
           ...
           if (Number(productId) !== Number(product.productId)){
            ...
            $('.product-list').html(productListHTML);
              var productListHTML = '<section class="product-list-section section-b-space"><div class="container-fluid-lg"><div class="title"><h2>Sản phẩm cùng thể loại</h2><span class="title-leaf"><svg class="icon-width"><use xlink:href="https://themes.pixelstrap.com/fastkart/assets/svg/leaf.svg#leaf"></use></svg></span></div><div class="row"><div class="col-12"><div class="slider-6_1 product-wrapper">';
            ...
            productListHTML += '</div></div></div></div></section>';
