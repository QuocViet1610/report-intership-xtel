...
// đánh giá sản phẩm 
  document.getElementById('submitReview').addEventListener('click', function () {
        ...
        const isActive = 1;   // Giá trị này có thể được thay đổi tùy theo trạng thái hoạt động của đánh giá
        ...
        $.ajax({
            url: '{{local}}/product-rating',  // Đường dẫn endpoint, thay {{local}} bằng địa chỉ thực tế
            method: 'POST',
            contentType: 'application/json',
