$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          productSame(product.categoryId, productId)
                saveProduct(product);
...
let cateId = searchRequest.getCategorySearch().trim();  // Loại bỏ khoảng trắng thừa
let url = `product-left-thumbnail.html?id=${product.productId}&cateId=${cateId}`;
...
function productSame(id, idproduct){
   var requestData = {
        searchText: "",
        categoryId: id,
    };
