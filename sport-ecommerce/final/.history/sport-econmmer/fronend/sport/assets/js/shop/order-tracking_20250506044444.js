    ...
    if(token){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                let cartHTML = ''; // Biến để chứa HTML của các sản phẩm trong giỏ hàng
...
orderDetail.forEach(item => {
    ...
    // Tạo HTML cho các thuộc tính của sản phẩm (nếu cần thiết)
    ...
    cartHTML += `
        <li>
            ...
            <h4 class="price">${totalPrice.toLocaleString('vi-VN')}đ</h4>
        </li>
    `;
});
