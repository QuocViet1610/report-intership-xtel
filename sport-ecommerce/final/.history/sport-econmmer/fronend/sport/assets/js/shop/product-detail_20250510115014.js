    ...
    success: function(response) {
        if (response.data && response.data.content) {
            ...
            products.forEach(function(product) {
                var imageUrl = product.imageUrl || 'default-image.jpg'; // Thêm fallback nếu không có imageUrl
                var productName = product.productName || 'Tên sản phẩm';
                var productPrice = product.productPrice || 'Giá chưa cập nhật';
                var productLink = 'product-left-thumbnail.html?id=' + product.productId;  // Tạo link chi tiết sản phẩm
                        ...
                        <div class="offer-product">
                            ...
                            <div class="offer-detail">
                                <div>
                                    ...
                                    <span></span>
                                    <h6 class="price theme-color">${productPrice}</h6>
                                </div>
                            </div>
                        </div>
                    </li>
