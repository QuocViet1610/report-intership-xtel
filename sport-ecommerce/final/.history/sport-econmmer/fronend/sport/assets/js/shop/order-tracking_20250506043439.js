    ...
    if(token){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById('shippingPrice').textContent = formatCurrency(response.data.shippingMethod === "Vận chuyển nhanh" ? 10000 : 0); // Thay đổi giá vận chuyển nếu cần
