        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                orderDetail.forEach(item => {
                    ...
                    let productPrice = item.productPrice.toString().replace(/[^\d.-]/g, ''); 
                    ...
                    if (item.productVariants && item.productVariants.length > 0) {
                        ...
                        productPrice = variant.price.toString().replace(/[^\d.-]/g, ''); 
                    ...
                    console.log(`Giá: ${productPrice.toLocaleString('vi-VN')}`);
                    console.log(`Số lượng: ${quantityProduct}`);
                    console.log(`Tổng giá: ${totalPrice.toLocaleString('vi-VN')}`);
