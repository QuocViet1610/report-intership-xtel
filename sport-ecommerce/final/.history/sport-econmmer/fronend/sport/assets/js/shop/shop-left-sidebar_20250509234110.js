...
brand = selectedBrandId;
    ...
    fetchDataApi(brand ,selectedItems,object);  
});
...
$('#sizeClothes, #sizeShoes, #colorsearch').on('change', 'input[type="checkbox"]', function() {
    ...
    fetchDataApi(null,selectedItems,object);
});
...
$('.js-range-slider').on('change', function() {
    ...
    document.getElementById('low').addEventListener('click', function() {
       fetchDataApi(null, null, null, 'productPrice.desc');
    });

    document.getElementById('high').addEventListener('click', function() {
        console.log('Giá từ cao đến thấp đã được chọn');
    });

    document.getElementById('aToz').addEventListener('click', function() {
        fetchDataApi(null, null, null, 'productName.asc');
    });

    document.getElementById('zToa').addEventListener('click', function() {
        console.log('Sắp xếp Z - A đã được chọn');
        fetchDataApi(null, null, null, 'productName.desc');
    });
