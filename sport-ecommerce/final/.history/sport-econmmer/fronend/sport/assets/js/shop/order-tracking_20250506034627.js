        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.code === '200') {
                    ...
                    document.getElementById('timePlaced').textContent = response.data.orderDate;
        
                    // Gán thời gian dự kiến đến vào thẻ có id là estimatedTime
                    document.getElementById('estimatedTime').textContent = response.data.estimatedDeliveryTime;
                }
            },
