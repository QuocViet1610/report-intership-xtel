...
function sanphambanchay(products){
    var productListHTML = '';
    products.forEach(function(product) {
        // Ensure productId is defined and compare it correctly
        if (Number(product.productId) !== Number(someProductId)) {  // Use a defined variable like `someProductId`
            var imageUrl = 'default-image.jpg'; // Default if no image found
            ...
            var productPrice = product.productPrice || 0;  // Default to 0 if price is missing
    ...
    // Insert the product list into the HTML container
