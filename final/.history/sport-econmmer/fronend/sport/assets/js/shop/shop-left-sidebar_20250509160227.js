...
$.ajax({
  ...
  response.forEach(function(attribute) {
            // attribute.values chứa mảng các kích thước
            attribute.attribute.values.forEach(function(size) {
                htmlContent += `
                    <li>
                        <div class="form-check ps-0 m-0 category-list-box">
                            <input class="checkbox_animated" type="checkbox" id="flexCheckDefault${size.name}">
