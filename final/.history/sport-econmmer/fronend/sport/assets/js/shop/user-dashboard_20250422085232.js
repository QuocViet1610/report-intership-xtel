    ...
    if (urlParams.has('order-history') && urlParams.get('order-history') === 'true') {
        ...
        $('#pills-order-tab').click();
                        ...
                        <div class="order-box dashboard-bg-box">
                           ...
                           <ul class="product-size" style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; justify-content: flex-end;">
                              <button class="btn btn-danger cancelOrderBtn" style="background-color: #dc3545; color:white; margin-right:10px" data-bs-toggle="modal" data-bs-target="#confirmCancelModal" data-order-id="${order.id}">Hủy Đơn Hàng</button>
            ...
            $('#confirmCancelBtn').on('click', function() {
                var orderId = $('#cancelOrderBtn').data('order-id');  
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        showSucess('Đơn hàng đã được hủy thành công!');
                        location.reload();  
                    },
                    error: function(xhr, status, error) {
