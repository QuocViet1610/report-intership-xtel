$(document).ready(function () {
    ...
    function renderProducts(products) {
        var productListHtml = '';  // Variable to store the HTML of products
    
        products.forEach(function(product) {
            // Find image with isPrimary = 1
            var primaryImage = product.productImages.find(image => image.isPrimary === 1);
            var imageUrl = primaryImage ? primaryImage.imageUrl : ''; // Default to empty if not found
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                ...
                                <div class="product-detail">
                                    <ul class="rating">
                                        ${renderStars(product.productTotalRating)} <!-- Function to render stars -->
                                    </ul>
                                    <a href="product-left-thumbnail.html?id=${product.productId}">
            ...
            productListHtml += productHtml;  // Append product to the HTML content
        });
    
        // Add products to the element with id 'top-product'
