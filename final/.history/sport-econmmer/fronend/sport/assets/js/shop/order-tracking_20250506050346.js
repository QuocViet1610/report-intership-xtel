        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                orderDetail.forEach(item => {
                    ...
                    let quantityProduct = item.quantity.toString().replace(/[^\d.-]/g, '').replace(/đ/g, '');;
                    ...
                    let productPrice = item.productPrice.toString().replace(/[^\d.-]/g, '').replace(/đ/g, '');
                    ...
                    if (item.productVariants && item.productVariants.length > 0) {
                        ...
                        productPrice = variant.price.toString().replace(/[^\d.-]/g, '').replace(/đ/g, '');
