                    ...
                    <ul class="product-option">
                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                data-bs-target="#view" onclick="quickView(${product.id})">
...
function loadRelatedProducts(categoryId) {
    // Tạo dữ liệu request
    const requestDatata = {
        fullParentId: categoryId, // id là biến toàn cục hoặc bạn cần gán giá trị cho nó
        categorySearch: parseInt(categoryId),
    };
    
    $.ajax({
        url: "http://localhost:8080/product/search?page=0&size=12",
        type: "POST", 
        contentType: "application/json",  
        data: JSON.stringify(requestDatata),  
        success: function(response) {
