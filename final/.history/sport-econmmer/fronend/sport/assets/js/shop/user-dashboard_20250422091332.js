                        ...
                        let orderHTML = `
                            ...
                            <ul class="product-size" style="display: flex; flex-direction: column;">
                                  ...
                                  <h5><strong>Tổng sản phẩm</strong>: ${order.totalProduct || 0} sản phẩm</h5>
                                        ...
                                        <li>
                                            <div class="size-box">
                                                  ...
                                                  <h5><strong>Tổng giá:</strong> ${new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(order.totalPrice)}</h5>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="size-box">
                                ...
                                <div style="display: flex; justify-content: flex-end;">
                                    ...
                                    <a href="order-tracking.html?orderId=${order.id}" style="display: block;  width: 15%; height: 40px;">
