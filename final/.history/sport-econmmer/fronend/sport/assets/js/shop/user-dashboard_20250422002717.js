                        ...
                        <div class="order-box dashboard-bg-box">
                           ...
                           <ul class="product-size" style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; justify-content: flex-end;">
                               <button class="btn btn-danger" style="background-color: #dc3545; color:white; margin-right:10px" data-bs-toggle="modal" data-bs-target="#confirmCancelModal" >Hủy Đơn Hàng</button>
