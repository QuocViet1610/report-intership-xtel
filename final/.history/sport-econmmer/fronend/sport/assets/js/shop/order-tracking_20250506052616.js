...
if(orderId){
            ...
            success: function(response) {
                ...
                orderDetail.forEach(item => {
                    ...
                    let productPrice = item.productPrice; 
                     ...
                     let totalPrice = parseInt(productPrice) * parseInt(quantityProduct);
 // Tính tổng giá của sản phẩm
                    ...
                    if (item.productVariants && item.productVariants.length > 0) {
                        ...
                        let totalPrice = parseInt(productPrice) * parseInt(quantityProduct); // Cập nhật tổng giá khi có variant
                    }
                    ...
                    <tr>
                        <td class="product-detail">
                            <div class="product border-0">
                                <a href="product.left-sidebar.html" class="product-image">
                                    <img src="${product.imageUrl}" class="img-fluid blur-up lazyload" alt="${product.productName}">
                                </a>
                        ...
                        <td class="price">
                            ...
                            <h6 class="theme-color">${parseInt(product.productPrice).toLocaleString()}đ</h6>
                        </td>
                        <td class="quantity">
                            <h4 class="table-title text-content">Số lượng</h4>
                            <h4 class="text-title">${product.quantityProduct}</h4>
                        </td>
                        <td class="subtotal">
                            <h4 class="table-title text-content">Tổng cộng</h4>
                            <h5>${parseInt(product.totalPrice).toLocaleString()}đ</h5>
                        </td>
                    </tr>`;
