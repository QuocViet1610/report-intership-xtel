        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                orderDetail.forEach(item => {
                    ...
                    console.log(`Màu sắc: ${item.productVariants[0] ? item.productVariants[0].name : 'Không có thông tin'}`);
                    console.log(`Kích cỡ: ${item.productVariants[0] ? item.productVariants[0].size : 'Không có thông tin'}`);
