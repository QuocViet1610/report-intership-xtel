...
$('input[type="checkbox"]').on('change', function() {
    // Lấy các giá trị đã chọn từ checkbox
    var selectedAttributes = [];
    if ($(this).is(':checked')) {
        // Nếu checkbox được chọn, lấy giá trị id của checkbox
        let checkboxId = $(this).attr('id');
        console.log("Checkbox ID được chọn:", checkboxId);
    }
    $('input[type="checkbox"]:checked').each(function() {
        selectedAttributes.push($(this).val());  // Lấy giá trị của checkbox đã chọn
    });

    // Gọi hàm fetchDataApi với các tham số tìm kiếm cập nhật
    fetchDataApi(null,selectedAttributes);
});
...
$('input[type="checkbox"]').on('change', function() {
    ...
    if ($(this).is(':checked')) {
        // Nếu checkbox được chọn, lấy giá trị id của checkbox
        let checkboxId = $(this).attr('id');
         selectedAttributes.push(checkboxId);
    }
        fetchDataApi(null,selectedAttributes);
});
